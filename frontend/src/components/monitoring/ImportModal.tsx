...
export const ImportModal: React.FC<ImportModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
            <div className="w-full max-w-lg glass-panel rounded-2xl border border-neon-cyan/40 shadow-2xl p-6 relative flex flex-col gap-4">
                {/* Header */}
                ...
                {activeTab === 'file' && (
                    <div className="space-y-4">
                        ...
                        <div className="border-2 border-dashed border-neon-cyan/30 rounded-xl p-6 flex flex-col items-center justify-center gap-2 hover:border-neon-cyan/70 transition cursor-pointer bg-black/30">
                            ...
                            <label className="text-xs text-gray-300 font-medium cursor-pointer">
                                ...
                                <input type="file" onChange={handleFileSelect} accept=".json,.md,.zip,.txt" className="hidden" />
                            </label>
                        </div>
